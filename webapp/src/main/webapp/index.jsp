...
OB<p1>DevOps: Jenkins (Pipelines), Azure DevOps,SonarQube,</p> 
OBPrisma Cloud, GitHub, Maven, Gradle.</p>   
<p1>OS: Windows & Linux.</p>
<p1>Containers: Docker & Kubernetes.</p>
<p1>IAC: Terraform.</p>
<p1>Web & App Servers: nginx, Tomcat & web sphere.</p>
OB<p1>DB: SQL Server, MySQL & RDS.</p>
OB

<h1>Academic Qualification</h1>
OBOB<p1>Bachelor of Technology (Computer science and engineering) from Vaagdevi college of engineering (JNTU-HYD) |2016.</p1>
